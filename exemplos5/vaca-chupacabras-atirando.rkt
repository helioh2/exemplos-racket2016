...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname vaca-chupacabras-atirando) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
...
(define (spawn-chupacabra ldcc)
  (cons (make-chupacabra X-SPAWN (random 1 5) Y-SPAWN (random 1 5)) ldcc))
